          ...
          <div className="w-full px-4 lg:w-7/12 xl:w-8/12">
            ...
            >
              <h2 className="mb-3 text-2xl font-bold text-black dark:text-white sm:text-3xl lg:text-2xl xl:text-3xl">
                ¿Quieres una secuencia gratis?
              </h2>
              <p className="mb-6 text-base font-medium text-body-color">
                Déjanos tu email y perfil de LinkedIn y te enviaremos 3 plantillas
                comprobadas y un checklist para lanzar campañas de outreach.
              </p>
              <form>
                <div className="-mx-4 flex flex-wrap">
